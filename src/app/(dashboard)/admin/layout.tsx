...
const navItems = [
  ...
  { name: "Data Siswa", href: "/admin/siswa", icon: GraduationCap },
  { name: "Master Kelas", href: "/admin/master/kelas", icon: School },
  { name: "Master Mapel", href: "/admin/master/mata-pelajaran", icon: BookOpen },
  { name: "Tahun Ajaran", href: "/admin/master/tahun-ajaran", icon: Calendar },
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      {/* Sidebar memiliki lebar tetap 260px sesuai variabel sidebar-width[cite: 1] */}
          ...
          {navItems.map((item) => {
            ...
            return (
              <Link
                key={item.href}
                href={item.href}
                // Warna solid Indigo (#4F46E5) digunakan untuk state aktif navigasi[cite: 1]
